"""
Django settings for youtube_videolist project.
...
SECRET_KEY = '!(f(1ad$+#3=0f=6*_$7s&_lgbf&e-b$4ce-#hw3r4_w^8jnbk'
...
ROOT_URLCONF = 'youtube_videolist.urls'
...
WSGI_APPLICATION = 'youtube_videolist.wsgi.application'
